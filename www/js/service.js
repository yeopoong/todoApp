angular.module('todo').factory('todoStorage', function($http, $q) {
  ...
  var storage = {
    ...
    get: function(callback) {
      $http.get('http://40.74.112.150:8080/api/todo')
    ...
    add: function(todo) {
      ...
      $http.post('http://40.74.112.150:8080/api/todo', {
          title: todo.title
        }).then(function success(response) {
    ...
    update: function(todo) {
      ...
      $http.put('http://40.74.112.150:8080/api/todo/' + todo.id, todo)
    ...
    remove: function(todo) {
      ...
      $http.delete('http://40.74.112.150:8080/api/todo/' + todo.id)
        .then(function successs(response) {
